...
<template>
  <div class="mx-auto rounded-xl drop-shadow-lg bg-white/70 sm:w-1/2 2xl:w-1/3 mt-8 p-8">
    ...
    <div class="mt-6 mb-2 flex">
      <div class="w-1/3 font-bold uppercase">
        {{ $t("theLogin.server") }}
      </div>
      <div class="w-2/3">
        <hr class="mt-3">
    ...
    <div class="flex">
      ...
      <div class="w-1/4 ml-2 text-center">
        &nbsp;<br>
        <input
          v-model="domoticz.server.useSSL"
          type="checkbox"
        >
        {{ $t("theLogin.useSSL") }}
      </div>
    ...
    <div class="flex">
      <div class="w-1/2 mr-2">
        ...
        <input
          v-model="domoticz.server.username"
          type="text"
          class="w-full text-center"
        >
      </div>
      <div class="w-1/2 ml-2">
        ...
        <input
          v-model="domoticz.server.password"
          type="password"
          class="w-full text-center"
        >
      </div>
    ...
    <div class="mt-8 flex">
      <div class="w-1/2 mr-2">
        <input
          v-model="domoticz.server.rememberMe"
          type="checkbox"
        >
      ...
      <div class="w-1/2 ml-2">
        <button
          class="primary w-full h-16 rounded-xl"
          @click="authenticate()"
        >
          {{ $t("theLogin.connect") }}
        </button>
